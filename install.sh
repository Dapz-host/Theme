...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY DAPZXYZ OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "DapzXyz@062010" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke DapzXyz${NC}"
    echo -e "${YELLOW}TELEGRAM : @Dapzjee${NC}"
    echo -e "${YELLOW}WHATSAPP : 62895324382888${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 15K FREE UPDATE KALAU ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©DapzXyz${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/Dapz-host/Theme/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/Dapz-host/Theme/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/Dapz-host/Theme/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/Dapz-host/Theme/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer DapzXyz   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Dapzjee   ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : DapzXyz  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by DapzXyz  ${NC}"
